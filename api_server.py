...
class CodeList(Resource):
    ...
    def get(self):
        ...
        for item in results:
            code_info = {}
            code_info = { code_hname_to_eng[field]: item[field] 
                         for field in item.keys() if field in code_hname_to_eng }
...
class Price(Resource):
    ...
    def get(self, code):
        ...
        for item in results:
            price_info = { price_hname_to_eng[field]: item[field] 
                          for field in item.keys() if field in price_hname_to_eng } 
