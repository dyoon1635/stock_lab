...
class MongoDBHandlerTestCase(unittest.TestCase):
    def setUp(self):
        ...
        docs = [
            ...
            { "item":"LG CNS"       , "related":"LG"     , "qty":50 , "tags":["blank", "red"], "account":[14, 21] },
            { "item":"SK Telecom"   , "related":"SK"     , "qty":100, "tags":["blank", "red"], "account":[14, 21] },
            { "item":"HYUNDAI MOBIS", "related":"HYUNDAI", "qty":75 , "tags":["blank", "red"], "account":[14, 21] },
            { "item":"SamSung SDI"  , "related":"SamSung", "qty":25 , "tags":["blank", "red"], "account":[14, 21] },
            { "item":"LG Telecom"   , "related":"LG"     , "qty":50 , "tags":["blank", "red"], "account":[14, 21] },
            { "item":"SK Innovation", "related":"SK"     , "qty":50 , "tags":["blank", "red"], "account":[14, 21] },            
        ]
    ...
    def test_text_search(self):
        print(inspect.stack()[0][3])
        index_result = self.mongodb._client["stocklab_test"]["corp_info"].create_index([
            ('item','text'), ('related','text'), ('tags','text')
        ])
        print(index_result)
